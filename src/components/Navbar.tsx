            ...
            {NAV_LINKS.map(link => {
              ...
              return (
                <a
                  ...
                  `}
                  style={{
                    textShadow: isActive ? '0 2px 8px rgba(29,185,84,0.18)' : '0 1px 4px rgba(0,0,0,0.18)',
                  }}
                >
                  {link.label}
                  ...
                  <span
                    className={`absolute left-0 -bottom-1 w-full bg-[#1db954] transition-transform duration-300 origin-left
                      ${isActive ? 'scale-x-100 h-1 shadow-[0_0_8px_2px_rgba(29,185,84,0.25)]' : 'scale-x-0 h-1'}
                      ${show ? 'group-hover:scale-x-100 group-focus:scale-x-100' : ''}
                    `}
                  />
                </a>
              );
